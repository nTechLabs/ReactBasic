        ...
        >
          <Space direction="vertical" size="middle" style={{ width: '100%' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '16px' }}>
              ...
              <Text type="secondary">
                mutable 객체를 반환하여 .current 속성으로 값에 접근하며, 값 변경 시 리렌더링을 발생시키지 않습니다
              </Text>
            </div>
...
console.log(countRef.current) // 새로운 값은 콘솔에만 출력`}
                      ...
                      <Text style={{ fontSize: '11px', color: '#eb2f96' }}>
                        💡 주의: ref 값 변경은 화면을 업데이트하지 않으므로, UI 표시용 데이터는 useState를 사용해야 합니다
                      </Text>
                    </div>
...
inputRef.current.value = 'Hello World'`}
                      ...
                      <Text style={{ fontSize: '11px', color: '#52c41a' }}>
                        💡 참고: ref 객체의 current 속성을 통해 실제 값이나 DOM 요소에 접근할 수 있습니다
                      </Text>
                    </div>
                      ...
                      <Col xs={24} md={12}>
                        <div style={{ 
                          ...
                          <ul style={{ 
                            ...
                            <li><strong>DOM 조작:</strong> focus, scroll, 크기 측정</li>
                            <li><strong>타이머 저장:</strong> setInterval, setTimeout ID</li>
                            <li><strong>이전 값 보관:</strong> props, state 변화 추적</li>
                            <li><strong>라이브러리 인스턴스:</strong> 써드파티 라이브러리 객체</li>
                            <li><strong>렌더링 최적화:</strong> 불필요한 리렌더링 방지</li>
                          </ul>
                        </div>
                      </Col>
