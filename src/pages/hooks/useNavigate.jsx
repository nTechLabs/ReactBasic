          ...
          description={
            <div>
              ...
              <ul style={{ marginTop: '8px', marginBottom: '8px' }}>
                <li>
                  <Text code>const navigate = useNavigate()</Text> - 네비게이션 함수 생성
                </li>
                <li>
                  <Text code>navigate('/path')</Text> - 특정 경로로 이동
                </li>
                <li>
                  <Text code>navigate(-1)</Text> - 뒤로 가기 (브라우저 히스토리)
                </li>
                <li>
                  <Text code>navigate(1)</Text> - 앞으로 가기 (브라우저 히스토리)
                </li>
                <li>
                  <Text code>navigate('/path', {`{replace: true}`})</Text> - 현재 히스토리 교체
                </li>
                <li>
                  <Text code>navigate('/path', {`{state: data}`})</Text> - 상태와 함께 이동
                </li>
              </ul>
              <Text type="secondary" style={{ fontSize: '12px' }}>
                💡 핵심: useNavigate는 사용자 액션이나 로직에 따라 프로그래매틱하게 페이지 이동을
                제어할 수 있습니다. 버튼 클릭, 폼 제출, 조건부 리다이렉트 등에 주로 사용됩니다.
              </Text>
            </div>
          }
          type="info"
            ...
            <Card size="small" title="네비게이션 컨트롤">
              <Space direction="vertical" style={{ width: '100%' }}>
                <div>
                  ...
                  <div style={{ marginTop: 8 }}>
                    <Space wrap>
                      ...
                      <Button onClick={navigateToHooks} icon={<ArrowRightOutlined />} size="small">
                        Hooks 목록
                      </Button>
                    </Space>
                  </div>
                ...
                <div>
                  ...
                  <div style={{ marginTop: 8 }}>
                    <Space wrap>
                      <Button onClick={goBack} icon={<ArrowLeftOutlined />} size="small">
                        뒤로
                      </Button>
                      <Button onClick={goForward} icon={<ArrowRightOutlined />} size="small">
                        앞으로
                      </Button>
                      <Button onClick={goBackTwoSteps} icon={<MinusOutlined />} size="small">
                        2단계 뒤로
                      </Button>
                    </Space>
                  </div>
        ...
        <Alert
          ...
          description={
            <div>
              ...
              <Text type="secondary" style={{ fontSize: '12px' }}>
                💡 핵심: 실제 애플리케이션에서 사용되는 보안과 사용자 경험을 고려한 네비게이션 가드
                패턴을 구현합니다.
              </Text>
            </div>
          }
          ...
          <Row gutter={16}>
            <Col xs={24} md={12}>
              <Space direction="vertical" style={{ width: '100%' }}>
                ...
                />
                <Button type="primary" onClick={submitFormAndNavigate} block>
                  폼 제출 후 이동
                </Button>
              </Space>
            </Col>
            <Col xs={24} md={12}>
              <div>
                ...
                <div style={{ marginTop: 8 }}>
                  <Button onClick={confirmAndGoBack} icon={<ArrowLeftOutlined />} block>
                    변경사항 확인 후 뒤로
                  </Button>
                </div>
      ...
      <Space direction="vertical" size="middle" style={{ width: '100%' }}>
          ...
          description={
            <div>
              ...
              <ul style={{ marginTop: '8px', marginBottom: '8px' }}>
                ...
                <li>
                  <Text code>navigate(`/path?${`{searchParams}`}`)</Text> - 쿼리 매개변수
                </li>
                <li>
                  <Text code>navigate(`/path#${`{hash}`}`)</Text> - 해시 프래그먼트
                </li>
                <li>
                  <Text code>navigate(path, {`{state: data}`})</Text> - 상태 객체 전달
                </li>
              </ul>
              <Text type="secondary" style={{ fontSize: '12px' }}>
                💡 핵심: URL을 동적으로 구성하여 다양한 데이터와 상태를 페이지 간에 전달할 수
                있습니다. SEO 친화적이며 북마크 가능한 URL을 생성합니다.
              </Text>
            </div>
          }
          type="warning"
          ...
          <Row gutter={16}>
            ...
            <Col xs={24} md={12}>
              <Space direction="vertical" style={{ width: '100%' }}>
                ...
                <Button type="primary" onClick={navigateWithQuery} block>
                  쿼리와 함께 이동
                </Button>
              </Space>
            </Col>
        ...
        <Card size="small" title="해시 프래그먼트 네비게이션">
          <Space wrap>
            {sections.map((section) => (
              <Button key={section} onClick={() => navigateWithHash(section)} size="small">
                #{section}
              </Button>
            ))}
          </Space>
        ...
        <Card size="small" title="커스텀 경로 네비게이션">
          <Space.Compact style={{ width: '100%' }}>
            ...
            />
            <Button type="primary" onClick={navigateToCustomPath}>
              이동
            </Button>
          </Space.Compact>
        </Card>
        ...
        <Card size="small" title="동적 라우팅 히스토리">
          <Timeline
            ...
            items={routeHistory.map((item) => ({
              color:
                item.type === 'custom path'
                  ? 'red'
                  : item.type === 'dynamic route'
                    ? 'blue'
                    : 'green',
              children: (
                <div>
        ...
        >
          <Space direction="vertical" size="middle" style={{ width: '100%' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '16px' }}>
              ...
              <Text type="secondary">
                링크 클릭이 아닌 JavaScript 코드를 통해 페이지 이동을 제어할 수 있게 해주는 강력한
                도구입니다
              </Text>
            </div>
...
navigate('/product/abc')`}
                          ...
                          <Text style={{ fontSize: '10px', color: '#666' }}>단순한 경로 이동</Text>
                        </div>
                      </Col>
...
navigate(-2)    // 2단계 뒤로`}
  ...
  navigate('/dashboard')
                          ...
                          >
                            ...
                            인증 상태를 확인하고 미인증 시 로그인 페이지로 리다이렉트. 원래 페이지
                            정보를 state로 전달하여 로그인 후 복귀 가능.
                          </div>
                        </div>
                      </Col>
                    </Row>
