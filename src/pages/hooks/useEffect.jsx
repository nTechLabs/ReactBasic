    ...
    clearInterval(timer)
                    ...
                    <Col xs={24} md={12}>
                      <div style={{ 
                        ...
                        <Text strong style={{ fontSize: '12px', color: '#fa541c', display: 'block', marginBottom: '8px' }}>
                          ⚠️ Cleanup이 필요한 경우
                        </Text>
                        <ul style={{ 
                          margin: '8px 0',
                ...
                {/* 주요 사용 사례 */}
                <div style={{ marginTop: '24px' }}>
                  <Title level={5} style={{ textAlign: 'center', marginBottom: '16px', color: '#1890ff' }}>
                    💡 주요 사용 사례
                  </Title>
        ...
        <Col xs={24} md={12} lg={8}>
          <Card title="🚀 컴포넌트 생명주기" size="small">
            ...
            <Alert
              ...
              description={
                <div>
                  ...
                  <ul style={{ marginTop: '8px', marginBottom: '8px', fontSize: '11px' }}>
                    <li><Text code>{"useEffect(() => {...}, [])"}</Text> - 마운트 시 한 번만 실행</li>
              ...
              type="success"
              size="small"
              style={{ backgroundColor: '#f6ffed', border: '1px solid #52c41a', marginBottom: '12px' }}
            />
            ...
            <Alert
              ...
              description={
                <div>
                  ...
                  <ul style={{ marginTop: '8px', marginBottom: '8px', fontSize: '11px' }}>
                    <li><Text code>{"useEffect(() => {...}, [count])"}</Text> - count 변경시에만 실행</li>
              ...
              type="info"
              size="small"
              style={{ backgroundColor: '#e6f7ff', border: '1px solid #1890ff', marginBottom: '12px' }}
            />
            ...
            <Alert
              ...
              description={
                <div>
                  ...
                  <ul style={{ marginTop: '8px', marginBottom: '8px', fontSize: '11px' }}>
                    <li><Text code>{"useEffect(() => {...}, [isRunning])"}</Text> - isRunning 변경시 실행</li>
              ...
              type="warning"
              size="small"
              style={{ backgroundColor: '#fff7e6', border: '1px solid #fa8c16', marginBottom: '12px' }}
            />
            ...
            <Alert
              ...
              description={
                <div>
                  ...
                  <ul style={{ marginTop: '8px', marginBottom: '8px', fontSize: '11px' }}>
                    <li><Text code>{"useEffect(() => {...}, [userId])"}</Text> - userId 변경시 API 호출</li>
              ...
              type="info"
              size="small"
              style={{ backgroundColor: '#e6fffb', border: '1px solid #13c2c2', marginBottom: '12px' }}
            />
            ...
            <Alert
              ...
              description={
                <div>
                  ...
                  <ul style={{ marginTop: '8px', marginBottom: '8px', fontSize: '11px' }}>
                    <li><Text code>{"useEffect(() => {...}, [])"}</Text> - 마운트 시 이벤트 리스너 등록</li>
              ...
              type="warning"
              size="small"
              style={{ backgroundColor: '#fff2e8', border: '1px solid #fa541c', marginBottom: '12px' }}
            />
            ...
            <Alert
              ...
              description={
                <div>
                  ...
                  <ul style={{ marginTop: '8px', marginBottom: '8px', fontSize: '11px' }}>
                    <li><Text code>{"useEffect(() => {...}, [])"}</Text> - 마운트 시 로컬 스토리지에서 데이터 로드</li>
                    <li><Text code>{"useEffect(() => {...}, [inputText])"}</Text> - 텍스트 변경시 자동 저장</li>
              ...
              type="info"
              size="small"
              style={{ backgroundColor: '#f9f0ff', border: '1px solid #722ed1', marginBottom: '12px' }}
            />
            ...
            <Alert
              ...
              description={
                <div>
                  ...
                  <ul style={{ marginTop: '8px', marginBottom: '8px', fontSize: '11px' }}>
                    <li><Text code>{"useEffect(() => {...}, [])"}</Text> - 마운트 시 타이머 시작</li>
              ...
              type="error"
              size="small"
              style={{ backgroundColor: '#fff0f6', border: '1px solid #eb2f96', marginBottom: '12px' }}
            />
