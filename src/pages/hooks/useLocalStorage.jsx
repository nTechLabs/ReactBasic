      ...
      <Space direction="vertical" size="middle" style={{ width: '100%' }}>
        <Row gutter={[16, 16]}>
          <Col xs={24} md={12}>
            ...
            <div>
              <Text>테마 설정</Text>
              <Select value={settings.theme} onChange={updateTheme} style={{ width: '100%' }}>
            ...
            <div>
              <Text>언어 설정</Text>
              <Select value={settings.language} onChange={updateLanguage} style={{ width: '100%' }}>
          ...
          <Col xs={24} md={12}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Text>알림 받기</Text>
              <Switch checked={settings.notifications} onChange={updateNotifications} />
            </div>

            {/* 자동 저장 */}
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Text>자동 저장</Text>
              <Switch checked={settings.autoSave} onChange={updateAutoSave} />
            </div>
          </Col>
        </Row>
        ...
        <Button type="primary" danger icon={<ClearOutlined />} onClick={resetSettings}>
          설정 초기화
        </Button>
      </Space>
    </Card>
    ...
    <Card title="할일 목록 관리 (LocalStorage)">
      ...
      >
        <Row gutter={[16, 8]}>
          <Col xs={24} md={12}>
            ...
            <Text strong>키:</Text> <Text code>'todoList'</Text> | <Text strong>초기값:</Text>{' '}
            <Text>빈 배열</Text>
            <br />
            <Text type="secondary" style={{ fontSize: '12px' }}>
              • 할일 항목들의 배열을 로컬스토리지에 저장
              <br />• 각 할일은 id, text, completed, createdAt 속성 포함
            </Text>
          </Col>
          <Col xs={24} md={12}>
            <Title level={5} style={{ margin: '8px 0 4px 0' }}>
            ...
            <Text strong>키:</Text> <Text code>'todoFilter'</Text> | <Text strong>초기값:</Text>{' '}
            <Text code>'all'</Text>
            <br />
            <Text type="secondary" style={{ fontSize: '12px' }}>
              • 할일 목록의 필터 조건을 별도로 저장
              <br />• 'all', 'active', 'completed' 상태 유지
            </Text>
          </Col>
          <Col span={24}>
            <Title level={5} style={{ margin: '8px 0 4px 0' }}>
          ...
          <Col span={24}>
            ...
            >
              <Text>• 추가: </Text>
              <Text code>setTodos(prev ={'> '}[...prev, newTodo])</Text>
              <br />
              <Text>• 수정: </Text>
              <Text code>
      ...
      <Space direction="vertical" size="middle" style={{ width: '100%' }}>
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} md={12}>
            <Card size="small">
              <Space>
                <Text>
                  전체: <Text type="secondary">{totalTodos}</Text>
                </Text>
                <Text>
                  진행중: <Text type="warning">{activeTodos}</Text>
                </Text>
                <Text>
                  완료: <Text type="success">{completedTodos}</Text>
                </Text>
              </Space>
            </Card>
          </Col>
            ...
            <Space direction="vertical" style={{ width: '100%' }}>
              {filteredTodos.map((todo) => (
                <Card
                  ...
                  actions={[
                    <Button type="text" size="small" onClick={() => toggleTodo(todo.id)}>
        ...
        <Space style={{ width: '100%', justifyContent: 'center' }}>
          {completedTodos > 0 && <Button onClick={clearCompleted}>완료된 할일 정리</Button>}
...
const NotesExample = () => {
  ...
  return (
    <Card title="사용자 노트 관리">
      ...
      >
        <Row gutter={[16, 8]}>
          <Col span={24}>
            <Text strong>키:</Text> <Text code>'userNotes'</Text> | <Text strong>초기값:</Text>{' '}
            <Text>빈 배열</Text>
          </Col>
          <Col span={24}>
            <Title level={5} style={{ margin: '8px 0 4px 0' }}>
  ...
  updatedAt: string        // 수정 시간
          ...
          <Col xs={24} md={12}>
            ...
            >
              <Text>• 생성: </Text>
              <Text code>setNotes(prev ={'> '}[newNote, ...prev])</Text>
              <br />
              <Text>• 수정: </Text>
              <Text code>
              ...
              <br />
              <Text>• 조회: </Text>
              <Text type="secondary">최신 노트가 먼저 오도록 배열 순서 관리</Text>
            </div>
          </Col>
          <Col span={24}>
            <Title level={5} style={{ margin: '8px 0 4px 0' }}>
          ...
          <Col xs={24} md={12}>
            ...
            >
              <Space direction="vertical" style={{ width: '100%' }}>
                ...
                />
                <Button type="primary" icon={<SaveOutlined />} onClick={saveNote} block>
